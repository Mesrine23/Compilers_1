...
class TestVisitor extends GJDepthFirst<String, String> {
    public SymbolTable symbolTable;
    public String mother_class;
    public String curr_class;
    public String curr_method;

    public TestVisitor(SymbolTable ST){
    ...
    public String visit(TimesExpression n, String argu) throws Exception {
        //System.out.println("Times Expression:\n");
        String expr1 = n.f0.accept(this,"~give_int");
        String expr2 = n.f2.accept(this,"~give_int");
        if(expr1.equals("int") && expr2.equals("int"))
            return "int";
    ...
    public String visit(MessageSend n, String argu) throws Exception {
        ...
        //System.out.println("prime_expr: " + prime_expr);
        String classCheck;
...
//            System.out.println(prime_expr);
    ...
    public String visit(Identifier n, String argu) throws Exception {
        if(argu.equals("~give_int")){
            ...
            String type = symbolTable.retType(n.f0.toString(),curr_class,mother_class,curr_method);
            if(type.equals("int[]")) {
                //System.out.println(symbolTable.varDecl.get(key));
                return "array~int";
            }
            else if (type.equals("boolean[]")) {
                //System.out.println(symbolTable.varDecl.get(key));
